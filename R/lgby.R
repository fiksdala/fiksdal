...
#' @param grid_var The grid-grouping variable. When using grid_var, it is essentially interchangable with facet_var, as together they determine the order and axis of the grid. grid_var cannot be used independently of facet_var for obvious reasons.
#' @keywords line graph
#' @export
#' @examples
#' lgby()

lgby <- function(df, x, y, by, facet_var, grid_var) {
